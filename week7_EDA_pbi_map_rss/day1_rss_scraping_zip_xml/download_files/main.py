...
if not os.path.exists(img_file):
       os.mkdir(img_file) #crea la imagen
if not os.path.exists(doc_file):
       os.mkdir(doc_file) # si no existe crea el archivo
...
def get_non_hidden_files_except_current_file(root_dir):
  ...
  #listdir accede a todos los ficheros y carpetas que estan dentro de root_dir. Lo va a devolver si os.path es un archivo, no una carpeta
  #  y no empiezan por punto, porque esos son archivos ocultos
