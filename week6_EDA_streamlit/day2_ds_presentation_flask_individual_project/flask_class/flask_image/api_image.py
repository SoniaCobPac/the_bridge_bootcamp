# static y template tienen que siempre existir y con esos nombres (es por el duo html y csv\
# html para template y lo que importo desde static)
...
def upload_image():
    ...
    if file:
        ...
        flash("Image successfully uploaded and displayed below")    #flash genera un mensaje que se muestra por pantalla
